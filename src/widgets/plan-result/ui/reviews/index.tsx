      ...
      <div className={styles.reviews}>
        ...
        <div className={styles.cases}>
          ...
          <Case
            name='Людмила'
            age={34}
            story={`Искала диету, которая подходила бы при диабете. Наткнулся на статью про кето питание, а потом повезло получить индивидуальный план питания. Рецепты разработаны под любой вкус и кошелек, полноценное питание и никакого голодания. Вес начал уходить, уровень сахара в крови падать и я начал жить по-новому! Нисколько не раздумывайте, покупайте кето план и худейте с удовольствием! Здоровье не купишь, а вот индивидуальный план вполне разумная трата!`}
            images={{
              before: case2_before,
              after: case2_after
            }}
